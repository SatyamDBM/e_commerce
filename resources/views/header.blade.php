        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
          ...
          <div class="d-flex align-items-center">
            <a class="navbar-brand" href="{{route('index')}}">
              <img src="{{asset('img/logo.svg')}}" alt="Logo" height="50" data-aos="zoom-out-down" data-aos-duration="3000" >
            </a>
            <i class="bi bi-list menu-icon text-light fs-2 ms-2" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"></i>
...
<li>
  @auth
    ...
    @endif
  @else
      <a class="dropdown-item text-danger fw-semibold py-2" href="#" data-bs-toggle="modal" data-bs-target="#loginModal">
