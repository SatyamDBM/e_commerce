    ...
    <section class="category-slider py-3">
      <div class="container-fluid position-relative">
        ...
        <div class="cat-slider-wrapper" id="catSlider">
          <div class="cat-item"><img src="{{ asset('img/t1.webp') }}" alt="Mobiles"></div>
          <div class="cat-item"><img src="{{ asset('img/t2.webp') }}" alt="Televisions"></div>
          <div class="cat-item"><img src="{{ asset('img/t3.webp') }}" alt="Air Conditioners"></div>
          <div class="cat-item"><img src="{{ asset('img/t4.webp') }}" alt="Kitchen Appliances"></div>
          <div class="cat-item"><img src="{{ asset('img/t5.webp') }}" alt="Laptops"></div>
          <div class="cat-item"><img src="{{ asset('img/t6.webp') }}" alt="Headphones"></div>
          <div class="cat-item"><img src="{{ asset('img/t7.webp') }}" alt="Water Purifiers"></div>
          <div class="cat-item"><img src="{{ asset('img/t8.webp') }}" alt="Refrigerators"></div>
          <div class="cat-item"><img src="{{ asset('img/t9.webp') }}" alt="Accessories"></div>
          <div class="cat-item"><img src="{{ asset('img/t10.webp') }}" alt="Washing Machines"></div>
          <div class="cat-item"><img src="{{ asset('img/t11.webp') }}" alt="Washing Machines"></div>
          <div class="cat-item"><img src="{{ asset('img/t12.webp') }}" alt="Washing Machines"></div>
          <div class="cat-item"><img src="{{ asset('img/t13.webp') }}" alt="Washing Machines"></div>
          <div class="cat-item"><img src="{{ asset('img/t14.webp') }}" alt="Washing Machines"></div>
          <div class="cat-item"><img src="{{ asset('img/t15.webp') }}" alt="Washing Machines"></div>
        </div>
