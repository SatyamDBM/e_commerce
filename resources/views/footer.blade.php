    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="d-flex align-items-center mb-3">
          <img src="{{asset('img/logo.svg')}}" alt="Logo" height="50" class="me-2"  data-aos="zoom-out-down" data-aos-duration="3000" >
          <h5 class="fw-bold"  data-aos="zoom-out-left" data-aos-duration="3000" >E_Commerce</h5>
        </div>
      ...
      <div class="col-lg-3 col-md-6">
        ...
        <form class="newsletter-form">
          <input type="email" id="footerEmail" name="email" placeholder="Enter your email" required autocomplete="email">
    ...
    <div class="modal-content rounded-4 overflow-hidden border-0 shadow-lg">
      ...
      <div class="row g-0">
        ...
        <div class="col-md-5 d-none d-md-flex flex-column justify-content-center align-items-center text-white text-center p-4"
          ...
          <p class="text-light small mb-0">Explore premium electronics & exciting offers, all in one place.</p>
        </div>
